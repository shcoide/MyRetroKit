                    ...
                    <div className="bg-white/95 rounded-[1.5rem] md:rounded-[2.5rem] p-5 md:p-16 lg:p-20 shadow-md border border-white/60">
                        ...
                        <div className="text-[#3B3B3B] text-base md:text-lg lg:text-[22px] space-y-6 md:space-y-10 leading-relaxed font-medium">
                            ...
                            <div className="text-center pt-6 md:pt-10 mt-6 md:mt-10 space-y-4">
                                <a href="https://docs.google.com/forms/d/e/1FAIpQLSdUEvTif7dSjNYqHUWqgZHapLc7GQrIgjshlVuFcu59JeqJjw/viewform?usp=sharing&ouid=104719618011702385644" target="_blank" rel="noreferrer" className="text-[#5B42D9] font-black hover:underline inline-block text-[17px] md:text-2xl break-all px-2">
                                    https://docs.google.com/forms/d/e/1FAIpQLSdUEvTif7dSjNYqHUWqgZHapLc7GQrIgjshlVuFcu59JeqJjw/viewform?usp=sharing&ouid=104719618011702385644
                                </a>
