export default function Footer() {
    return (
        <div className="w-full bg-white/95 backdrop-blur-sm px-8 py-6 border-t border-gray-200/50 shadow-sm">
            {/* Added md:items-end to align the right container to the bottom on desktop */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end text-sm text-gray-700 max-w-7xl mx-auto">
